 ...
 * Timestamp:                                          2024-08-29 12:43:36 GMT+02:00
 *
 ...
 * ========
 * Part:               Si5345AB Rev D
 * Project File:       C:\Users\jdievernich\Desktop\Si5345A-D16027-GM-v0-Project.slabtimeproj
 * Design ID:          <none>
 * Created By:         ClockBuilder Pro v2.45 [2020-07-16]
 * Timestamp:          2024-08-29 12:43:35 GMT+02:00
 * 
 * Design Rule Check
 * =================
 * Errors:
 ...
 * 
 * Warnings:
 * - OUT1 [100 MHz] and OUT2 [297 MHz] may have coupling [1]
 * - OUT2 [297 MHz] and OUT3 [100 MHz] may have coupling [1]
 * - OUT5 [50 MHz] and OUT6 [24 MHz] may have coupling [1]
 * - OUT6 [24 MHz] and OUT7 [25 MHz] may have coupling [1]
 ...
 *          Enabled, LVDS 1.8 V
 *    OUT2: 297 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT3: 100 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT4: 200 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT5: 50 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT6: 24 MHz (Free Run)
 *          Enabled, LVCMOS In-Phase 1.8 V 31 ?
 *    OUT7: 25 MHz (Free Run)
 *          Enabled, LVCMOS In-Phase 3.3 V 22 ?
 *    OUT8: 25 MHz (Free Run)
 *          Enabled, LVCMOS In-Phase 3.3 V 22 ?
 ...
 *       OUT9: 100 MHz
 *    N3:
 *       Value: 22.2222222222222222... [ 22 + 2/9 ]
 *       OUT2: 297 MHz
 *    N4:
 *       Value: 132
 *       OUT5: 50 MHz
 ...
 * Airflow:  2 m/s
 * 
 * Total Power: 1.035 W, On Chip Power: 993 mW, Tj: 43 °C
 * 
 *         Frequency  Format              Voltage   Current     Power
 *         ---------  -----------------  --------  --------  --------
 * VDD                                      1.8 V  184.7 mA    332 mW
 * VDDA                                     3.3 V  116.6 mA    385 mW
 * VDDO0     100 MHz  LVDS                  1.8 V   15.5 mA     28 mW
 * VDDO1     100 MHz  LVDS                  1.8 V   15.5 mA     28 mW
 * VDDO2     297 MHz  LVDS                  1.8 V   16.3 mA     29 mW
 * VDDO3     100 MHz  LVDS                  1.8 V   15.5 mA     28 mW
 * VDDO4     200 MHz  LVDS                  1.8 V   15.9 mA     29 mW
 * VDDO5      50 MHz  LVDS                  1.8 V   15.2 mA     27 mW
 * VDDO6      24 MHz  LVCMOS (in-phase)     1.8 V   13.9 mA     25 mW
 * VDDO7      25 MHz  LVCMOS (in-phase)     3.3 V   14.5 mA     48 mW
 * VDDO8      25 MHz  LVCMOS (in-phase)     3.3 V   14.5 mA     48 mW
 * VDDO9     100 MHz  LVDS                  1.8 V   15.5 mA     28 mW
 *                                                 --------  --------
 *                                          Total  453.6 mA   1.035 W
 * 
 * Note:
 * 
 ...
 * 0x024A[23:0]  R0_REG                      5                  0x000005         
 * 0x024D[23:0]  R1_REG                      5                  0x000005         
 * 0x0250[23:0]  R2_REG                      0                  0x000000         
 * 0x0253[23:0]  R3_REG                      5                  0x000005         
 * 0x0256[23:0]  R4_REG                      2                  0x000002         
 * 0x0259[23:0]  R5_REG                      0                  0x000000         
 * 0x025C[23:0]  R6_REG                      24                 0x000018         
 * 0x025F[23:0]  R7_REG                      23                 0x000017         
 * 0x0262[23:0]  R8_REG                      23                 0x000017         
 ...
 * 0x0318[43:0]  N2_NUM                      141733920768       0x02100000000    
 * 0x031E[31:0]  N2_DEN                      2147483648         0x80000000       
 * 0x0322[0]     N2_UPDATE                   0                  0x0              
 * 0x0323[43:0]  N3_NUM                      53687091200        0x00C80000000    
 * 0x0329[31:0]  N3_DEN                      2415919104         0x90000000       
 * 0x032D[0]     N3_UPDATE                   0                  0x0              
 * 0x032E[43:0]  N4_NUM                      283467841536       0x04200000000    
 * 0x0334[31:0]  N4_DEN                      2147483648         0x80000000       
 ...
 * 0x0A03[4:0]   N_CLK_TO_OUTX_EN            29                 0x1D             
 * 0x0A04[4:0]   N_PIBYP                     21                 0x15             
 * 0x0A05[4:0]   N_PDNB                      29                 0x1D             
